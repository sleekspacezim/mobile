...
import { ICommercialRentalFeaturesInfo } from "../Types/FormTypes";
...
type Props = {
  propertyDetails: ICommercialRentalFeaturesInfo;
  setPropertyDetails: React.Dispatch<
    React.SetStateAction<ICommercialRentalFeaturesInfo>
  >;
};
