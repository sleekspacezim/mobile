...
import { getManagerStands } from "@/src/HttpServices/Queries/Manager/ManagerHttpFuncs";
...
const MyStandProperties: React.FC<Props> = ({ setTotalproperties }) => {
  const [properties, setProperties] = useState<IStandPropertyWithManager[]>([]);
...
export default MyStandProperties;
