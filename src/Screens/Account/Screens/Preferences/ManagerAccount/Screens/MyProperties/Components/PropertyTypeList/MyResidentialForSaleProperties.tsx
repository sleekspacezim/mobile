...
import { getManagerResidentialForSaleProperties } from '@/src/HttpServices/Queries/Manager/ManagerHttpFuncs';
...
const MyResidentialForSaleProperties: React.FC<Props> = ({
  setTotalproperties,
}) => {
  ...
  const fetchProperties = () => {
    getManagerResidentialForSaleProperties({
      page: 1,
      accessToken,
      pageLimit,
      managerId: id,
  ...
  const text = "You currently do not have residential properties forsale.";
...
export default MyResidentialForSaleProperties