...
import { getManagerLandProperties } from "@/src/HttpServices/Queries/Manager/ManagerHttpFuncs";
...
const MyLandProperties: React.FC<Props> = ({ setTotalproperties }) => {
  const [properties, setProperties] = useState<ILandPropertyWithManager[]>([]);
...
export default MyLandProperties;
