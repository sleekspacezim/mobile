...
import { getManagerCommercialRentalProperties } from "@/src/HttpServices/Queries/Manager/ManagerHttpFuncs";
...
const MyCommercialRentalProperties: React.FC<Props> = ({
  setTotalproperties,
}) => {
  ...
  const fetchProperties = () => {
    getManagerCommercialRentalProperties({
      page: 1,
      accessToken,
      pageLimit,
      managerId: id,
  ...
  const text = "You currently do not have rental commercial properties.";
...
export default MyCommercialRentalProperties;
